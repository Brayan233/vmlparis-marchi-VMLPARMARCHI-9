...
$.fn.linotype_field_container = function(){
    ...
    var $value = $this.find('> .composer-item-value');
      ...
      $this.find('> .composer-item-content > .container > .composer-items > .composer-item').each( function( index_content, content ) {
...
$(document).ready(function(){
	...
	$('body').find('.linotype_field_container').linotype_field_container();

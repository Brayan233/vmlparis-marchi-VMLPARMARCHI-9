...
$.fn.wp_field_uploader = function(){
	...
	$(this).each(function(){
		...
		var $UPLOADER_uploader_key = $UPLOADER.attr('data-uploader-key');
		...
		*/
		function uploader_init() {
			...
			if ( $UPLOADER_uploader_key ) $UPLOADER_PARAMS.multipart_params.uploader_key = $UPLOADER_uploader_key;
			...
			$UPLOADER.on('mouseover mouseout mousedown click', ".moxie-shim", function(e) {

				if ( e.type == 'mouseover') {
				
					$("#plupload-browse-button").addClass("hover").addClass("focus");
				
				} else if ( e.type == 'mousedown' || e.type == 'click' ) {
				
					$("#plupload-browse-button").addClass("active");
					$("#plupload-browse-button").removeClass("hover").removeClass("focus");

				} else {

					$("#plupload-browse-button").removeClass("active");
					$("#plupload-browse-button").removeClass("hover").removeClass("focus");
			...
			$(window).on('resize', function(e) {
				...
				clearTimeout( uploader_resize );
				
				uploader_resize = setTimeout(function() {
			...
			uploader.bind('BeforeUpload', function(up, file) {
				...
				// if ( $UPLOADER.attr('data-uploader-custom-params') ) {

				// 	up.settings.multipart_params.custom_params = $.parseJSON( $UPLOADER.attr('data-uploader-custom-params') );
				
				// 	console.log( up.settings.multipart_params.custom_params );
				
				// }

				up.settings.multipart_params.source = file.name;
		...
		*/
		function uploadSuccess( fileObj, response ) {
			...
			if ( response.type == "success" ) {
				...
				$('.' + $('.field-uploader').attr('data-id') ).val( $json );
...
$(document).ready(function(){
	...
	$('body').find('.handypress-uploader').wp_field_uploader();

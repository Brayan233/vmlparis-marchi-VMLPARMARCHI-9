...
if (isset($_GET['upload']) && !FM_READONLY) {
    ...
    <div class="path">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]).'?dirmanager_id=' .  $_REQUEST['dirmanager_id'] . '&p='.fm_enc(FM_PATH) ?>" class="dropzone" id="fileuploader" enctype="multipart/form-data">
    ...
    <div class="path">
        ...
        <form action="" method="post">
            ...
            <p>
                ...
                <b><a href="?dirmanager_id=<?php echo $_REQUEST['dirmanager_id']; ?>&p=<?php echo urlencode(FM_PATH) ?>"><i class="fa fa-times-circle"></i> Cancel</a></b>
            </p>
        </form>
    </div>
    <?php
...
if (isset($_GET['copy']) && !isset($_GET['finish']) && !FM_READONLY) {
    ...
    <div class="path">
        ...
        <p>
            <b><a href="?dirmanager_id=<?php echo $_REQUEST['dirmanager_id']; ?>&p=<?php echo urlencode(FM_PATH) ?>&amp;copy=<?php echo urlencode($copy) ?>&amp;finish=1"><i class="fa fa-check-circle"></i> Copy</a></b> &nbsp;
            <b><a href="?dirmanager_id=<?php echo $_REQUEST['dirmanager_id']; ?>&p=<?php echo urlencode(FM_PATH) ?>&amp;copy=<?php echo urlencode($copy) ?>&amp;finish=1&amp;move=1"><i class="fa fa-check-circle"></i> Move</a></b> &nbsp;
            <b><a href="?dirmanager_id=<?php echo $_REQUEST['dirmanager_id']; ?>&p=<?php echo urlencode(FM_PATH) ?>"><i class="fa fa-times-circle"></i> Cancel</a></b>
        </p>
...
if (isset($_GET['view'])) {
    ...
    <div class="path">
        ...
        <p>
            <b><a href="?dirmanager_id=<?php echo $_REQUEST['dirmanager_id']; ?>&p=<?php echo urlencode(FM_PATH) ?>&amp;dl=<?php echo urlencode($file) ?>"><i class="fa fa-cloud-download"></i> Download</a></b> &nbsp;
            ...
            if (!FM_READONLY && $is_zip && $filenames !== false) {
                ...
                ?>
                <b><a href="?dirmanager_id=<?php echo $_REQUEST['dirmanager_id']; ?>&p=<?php echo urlencode(FM_PATH) ?>&amp;unzip=<?php echo urlencode($file) ?>"><i class="fa fa-check-circle"></i> UnZip</a></b> &nbsp;
                <b><a href="?dirmanager_id=<?php echo $_REQUEST['dirmanager_id']; ?>&p=<?php echo urlencode(FM_PATH) ?>&amp;unzip=<?php echo urlencode($file) ?>&amp;tofolder=1" title="UnZip to <?php echo fm_enc($zip_name) ?>"><i class="fa fa-check-circle"></i>
                    UnZip to folder</a></b> &nbsp;
                <?php
            }
            if($is_text && !FM_READONLY) {
            ?>
            <b><a href="?dirmanager_id=<?php echo $_REQUEST['dirmanager_id']; ?>&p=<?php echo urlencode(trim(FM_PATH)) ?>&amp;edit=<?php echo urlencode($file) ?>" class="edit-file"><i class="fa fa-pencil-square"></i> Edit</a></b> &nbsp;
            <b><a href="?dirmanager_id=<?php echo $_REQUEST['dirmanager_id']; ?>&p=<?php echo urlencode(trim(FM_PATH)) ?>&amp;edit=<?php echo urlencode($file) ?>&env=ace" class="edit-file"><i class="fa fa-pencil-square"></i> Advanced Edit</a></b> &nbsp;
            <?php }
            ...
            <?php } ?>
            <b><a href="?dirmanager_id=<?php echo $_REQUEST['dirmanager_id']; ?>&p=<?php echo urlencode(FM_PATH) ?>"><i class="fa fa-chevron-circle-left"></i> Back</a></b>
        </p>
        <?php
        if ($is_zip) {
            // ZIP content
...
if ($parent !== false) {
    ?>
<tr><?php if (!FM_READONLY): ?><td></td><?php endif; ?><td colspan="<?php echo !FM_IS_WIN ? '6' : '4' ?>"><a href="?dirmanager_id=<?php echo $_REQUEST['dirmanager_id']; ?>&p=<?php echo urlencode($parent) ?>"><i class="fa fa-chevron-circle-left"></i> ..</a></td></tr>
<?php
}
foreach ($folders as $f) {
...
<td><div class="filename"><a href="?dirmanager_id=<?php echo $_REQUEST['dirmanager_id']; ?>&p=<?php echo urlencode(trim(FM_PATH . '/' . $f, '/')) ?>"><i class="<?php echo $img ?>"></i> <?php echo fm_convert_win($f) ?></a><?php echo ($is_link ? ' &rarr; <i>' . readlink($path . '/' . $f) . '</i>' : '') ?></div></td>
<td>Folder</td><td><?php echo $modif ?></td>
<?php if (!FM_IS_WIN): ?>
<td><?php if (!FM_READONLY): ?><a title="Change Permissions" href="?dirmanager_id=<?php echo $_REQUEST['dirmanager_id']; ?>&p=<?php echo urlencode(FM_PATH) ?>&amp;chmod=<?php echo urlencode($f) ?>"><?php echo $perms ?></a><?php else: ?><?php echo $perms ?><?php endif; ?></td>
<td><?php echo $owner['name'] . ':' . $group['name'] ?></td>
<?php endif; ?>
<td class="inline-actions"><?php if (!FM_READONLY): ?>
<a title="Delete" href="?dirmanager_id=<?php echo $_REQUEST['dirmanager_id']; ?>&p=<?php echo urlencode(FM_PATH) ?>&amp;del=<?php echo urlencode($f) ?>" onclick="return confirm('Delete folder?');"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
...
<a title="Copy to..." href="?dirmanager_id=<?php echo $_REQUEST['dirmanager_id']; ?>&p=&amp;copy=<?php echo urlencode(trim(FM_PATH . '/' . $f, '/')) ?>"><i class="fa fa-files-o" aria-hidden="true"></i></a>
<?php endif; ?>
...
<?php if (!FM_IS_WIN): ?>
<td><?php if (!FM_READONLY): ?><a title="<?php echo 'Change Permissions' ?>" href="?dirmanager_id=<?php echo $_REQUEST['dirmanager_id']; ?>&p=<?php echo urlencode(FM_PATH) ?>&amp;chmod=<?php echo urlencode($f) ?>"><?php echo $perms ?></a><?php else: ?><?php echo $perms ?><?php endif; ?></td>
<td><?php echo fm_enc($owner['name'] . ':' . $group['name']) ?></td>
<?php endif; ?>
<td class="inline-actions">
<?php if (!FM_READONLY): ?>
<a title="Delete" href="?dirmanager_id=<?php echo $_REQUEST['dirmanager_id']; ?>&p=<?php echo urlencode(FM_PATH) ?>&amp;del=<?php echo urlencode($f) ?>" onclick="return confirm('Delete file?');"><i class="fa fa-trash-o"></i></a>
...
<a title="Copy to..." href="?dirmanager_id=<?php echo $_REQUEST['dirmanager_id']; ?>&p=<?php echo urlencode(FM_PATH) ?>&amp;copy=<?php echo urlencode(trim(FM_PATH . '/' . $f, '/')) ?>"><i class="fa fa-files-o"></i></a>
<?php endif; ?>
<a title="Direct link" href="<?php echo fm_enc(FM_ROOT_URL . (FM_PATH != '' ? '/' . FM_PATH : '') . '/' . $f) ?>" target="_blank"><i class="fa fa-link"></i></a>
<a title="Download" href="?dirmanager_id=<?php echo $_REQUEST['dirmanager_id']; ?>&p=<?php echo urlencode(FM_PATH) ?>&amp;dl=<?php echo urlencode($f) ?>"><i class="fa fa-download"></i></a>
</td></tr>
    <?php
    flush();
}
		...
		foreach( $file as $this_file ) {
			if( $this_file != "." && $this_file != ".." ) {
				if( is_dir("$directory/$this_file") ) {
					...
					$link = "?dirmanager_id=" .  $_REQUEST['dirmanager_id'] . "&p="."$path" ."&view=".urlencode($this_file);
...
<div class="path main-nav">
        ...
        <?php
        $path = fm_clean_path($path);
        $root_url = "<a href='?dirmanager_id=" .  $_REQUEST['dirmanager_id'] . "&p='><i class='fa fa-home' aria-hidden='true' title='" . FM_ROOT_PATH . "'></i></a>";
        ...
        if ($path != '') {
            ...
            for ($i = 0; $i < $count; $i++) {
                ...
                $array[] = "<a href='?dirmanager_id=" .  $_REQUEST['dirmanager_id'] . "&p={$parent_enc}'>" . fm_enc(fm_convert_win($exploded[$i])) . "</a>";
            }
        ...
        <a title="Upload files" href="?dirmanager_id=<?php echo $_REQUEST['dirmanager_id']; ?>&p=<?php echo urlencode(FM_PATH) ?>&amp;upload"><i class="fa fa-cloud-upload" aria-hidden="true"></i></a>

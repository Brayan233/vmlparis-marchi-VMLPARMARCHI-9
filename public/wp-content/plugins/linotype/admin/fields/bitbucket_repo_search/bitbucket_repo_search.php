...
if ( isset( $_GET["action"] ) && $_GET["action"] == 'search' ) {
  ...
  $wb_get_repos_search = wb_get_repos_search( $_GET["owner"] );

  if ( $wb_get_repos_search && is_object( $wb_get_repos_search ) && ! is_a( $wb_get_repos_search, 'WP_Error' ) ) {

    usort($wb_get_repos_search->values , function($a, $b) {
      return strcmp($b->updated_on, $a->updated_on);
    });

    $repos = $wb_get_repos_search->values;
...
$current_owner = '';
if ( isset( $_GET["owner"] ) ) $current_owner = $_GET["owner"];
...
<div id="plugin-filter" method="post">
  ...
  <div class="wp-list-table widefat plugin-install">
    ...
    <div class="field-input" style="margin-top:10px;margin-bottom:20px;">
      <input class="bucketpress-search wp-field-value meta-field" data-baseurl="<?php echo admin_url('admin.php?page=bucketpress_setting' ); ?>" type="text" autocorrect="off" autocomplete="off" spellcheck="false" placeholder="Owner" value="<?php echo $current_owner; ?>" />
    </div>
    ...
    <div id="the-list">
          ...
          <div class="bucketpress-repo plugin-card">
            ...
            <div class="plugin-card-top">
              ...
              <div class="desc column-description">
                ...
                <p class="authors"> <cite>By <a href="#"><?php echo $repo->owner; ?></a></cite> <?php if ( $repo->has_issues ) { ?><i class="fa fa-bug"></i> Has Issues <?php } ?></p>
      ...
      <?php } else { ?>
        ...
        <p>No repositories listed, please type owner username and press enter to find his repositories</p>

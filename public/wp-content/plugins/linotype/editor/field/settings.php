        ...
        <div class="linoadmin-col">
            ...
            <ul>
                <li class="linotype-field">
                    ...
                    <input name="target" type="text" style="width:270px;" value="<?php echo implode( ',', $LINOTYPE_EDITOR['data']['target'] ); ?>" autocomplete="off">
                </li>
                <li class="linotype-field">
                    <span class="customize-control-title">parent</span>
                    <input name="parent" type="text" style="width:270px;" value="<?php echo implode( ',', $LINOTYPE_EDITOR['data']['parent'] ); ?>" autocomplete="off">
                </li>
                <li class="linotype-field">
                    <span class="customize-control-title">accept</span>
                    <input name="accept" type="text" style="width:270px;" value="<?php echo implode( ',', $LINOTYPE_EDITOR['data']['accept'] ); ?>" autocomplete="off">
                </li>
                <li class="linotype-field">
                    <span class="customize-control-title">libraries</span>
                    <input name="libraries" type="text" style="width:270px;" value="<?php echo implode( ',', $LINOTYPE_EDITOR['data']['libraries'] ); ?>" autocomplete="off">
                </li>
            </ul>  

...
$BLOCKS_DATA = LINOTYPE::$LIBRARIES->get();
...
if ( $BLOCKS_DATA ) {
    foreach ( $BLOCKS_DATA as $item_key => $item ) {
        ...
        if ( isset( $item['dir'] ) && $item['dir'] ) {
            ...
            linolog( 'libraries errors : ' . $item_key, $item );
    ...
    "options" => array(
        ...
        'toolbar' => function(){
            ...
            echo '<div style="editor-toolbar">
                ...
                <a class="button" href="' . LINOTYPE_plugin::$plugin['url'] . 'editor/index.php?type=fetch&target=library#libraries" id="linotype-fetch">Fetch</a>
                <a class="button"  href="' . LINOTYPE_plugin::$plugin['url'] . 'editor/index.php?type=import&target=library" class="page-title-action">Import</a>
                <a class="button button-primary"  href="' . LINOTYPE_plugin::$plugin['url'] . 'editor/index.php?type=add&target=library" class="page-title-action">Add Library</a>

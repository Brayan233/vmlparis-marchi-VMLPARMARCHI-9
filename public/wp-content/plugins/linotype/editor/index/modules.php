...
$BLOCKS_DATA = LINOTYPE::$MODULES->get();
...
if ( $BLOCKS_DATA ) {
    foreach ( $BLOCKS_DATA as $item_key => $item ) {
        ...
        if ( isset( $item['dir'] ) && $item['dir'] ) {
            ...
            linolog( 'modules errors : ' . $item_key, $item );
    ...
    "options" => array(
        ...
        'toolbar' => function(){
            ...
            echo '<div style="editor-toolbar">
                ...
                <a class="button" href="' . LINOTYPE_plugin::$plugin['url'] . 'editor/index.php?type=fetch&target=module#modules" id="linotype-fetch">Fetch</a>
                <a class="button"  href="' . LINOTYPE_plugin::$plugin['url'] . 'editor/index.php?type=import&target=module" class="page-title-action">Import</a>
                <a class="button button-primary"  href="' . LINOTYPE_plugin::$plugin['url'] . 'editor/index.php?type=add&target=module" class="page-title-action">Add Module</a>

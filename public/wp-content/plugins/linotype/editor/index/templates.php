...
$BLOCKS_DATA = LINOTYPE::$TEMPLATES->get();
...
if ( $BLOCKS_DATA ) {
    foreach ( $BLOCKS_DATA as $item_key => $item ) {
        ...
        if ( isset( $item['dir'] ) && $item['dir'] ) {
            ...
            linolog( 'templates errors : ' . $item_key, $item );
    ...
    "options" => array(
        ...
        'toolbar' => function(){
            ...
            echo '<div style="editor-toolbar">
                ...
                <a class="button" href="' . LINOTYPE_plugin::$plugin['url'] . 'editor/index.php?type=fetch&target=template#templates" id="linotype-fetch">Fetch</a>
                <a class="button"  href="' . LINOTYPE_plugin::$plugin['url'] . 'editor/index.php?type=import&target=template" class="page-title-action">Import</a>
                <a class="button button-primary"  href="' . LINOTYPE_plugin::$plugin['url'] . 'editor/index.php?type=add&target=template" class="page-title-action">Add Template</a>
